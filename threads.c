...
int main(int argc, char * argv[])
{
    ...
    if (signal(SIGQUIT, sigusr1_handler) == SIG_ERR)
    {
...
static
void parse_arguments(int numCommands, const char ** commands, int * statusArray)
{
    if (numCommands != 4)
    {
